...
const reasons = [
  { num: "01", icon: "⚡", title: "High Energy & Enthusiasm", desc: "Radhaa has a knack for instantly lighting up any venue. Her voice is assertive yet friendly, commanding attention from the first word without ever needing to shout." },
  ...
  { num: "05", icon: "💎", title: "Elegance & Professionalism", desc: "From formal gowns for corporate galas to vibrant outfits for cultural events — Radhaa embodies professional glamour, punctuality, and thorough preparation." },
...
export default function WhyRadhaSection() {
  ...
  return (
    <section className="py-24 px-6">
      ...
      >
        <p className="text-primary tracking-[0.3em] text-xs uppercase text-center mb-2">Why Radhaa?</p>
        ...
        <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-16 text-sm leading-relaxed">
          Radhaa is frequently praised as an "articulate and engaging anchor" who brings a unique blend of
