...
const reasons = [
  ...
  { num: "03", icon: "🎭", title: "Spontaneity & Grace", desc: "Schedule change? Chief guest running late? AV glitch? Radha's improv skills and quick wit keep the audience entertained no matter what happens backstage." },
